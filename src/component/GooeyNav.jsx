...
const createParticle = ({ i, t, particleDistances, particleR, particleCount, colors }) => {
...
const makeParticles = (element, options) => {
  const { particleDistances, particleR, particleCount, animationTime, timeVariance, colors } = options;
